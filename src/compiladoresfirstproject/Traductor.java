    ...
    private void declararIf() {
            ...
            try
        {
            ...
            pw = new PrintWriter(fichero);
                ...
                while(!")".equals(con)){
                    con=sc.nextLine();
                    if("=".equals(con))pw.print("=");
                    if(con.equals("TRUE")||con.equals("FALSE"))pw.print(con.toLowerCase());
                    else{
                        pw.print(con);
                    }
                }
    ...
    private void haga() {
            ...
            try
        {
            ...
            if(line.equals("MIENTRAS")){
                ...
                while(!")".equals(line)){
                    line=sc.nextLine();
                    if("=".equals(line))pw1.print("=");
                    if(line.equals("TRUE")||line.equals("FALSE"))pw1.print(line.toLowerCase());
                    else{
                        pw1.print(line);
                    }
                }
